...
public class TestAnimal
{
	...
	public void InitialAssertTest1()
	{
		...
		assertEquals("1.Lokasi initial X salah!",0,animaltest.getLocationX());
		assertEquals("1.Lokasi initial Y salah!",0,animaltest.getLocationY());
	...
	public void InitialAssertTest2()
	{
		...
		assertEquals("2.Lokasi initial X salah!",0,animaltest.getLocationX());
		assertEquals("2.Lokasi initial Y salah!",0,animaltest.getLocationY());
	...
	public void InitialAssertTest3()
	{
		...
		assertEquals("3.Lokasi initial X salah!",0,animaltest.getLocationX());
		assertEquals("3.Lokasi initial Y salah!",0,animaltest.getLocationY());
	...
	public void InitialAssertTest4()
	{
		...
		assertEquals("4.Lokasi initial X salah!",0,animaltest.getLocationX());
		assertEquals("4.Lokasi initial Y salah!",0,animaltest.getLocationY());
	...
	public void InitialAssertTest5()
	{
		...
		assertEquals("5.Lokasi initial X salah!",0,animaltest.getLocationX());
		assertEquals("5.Lokasi initial Y salah!",0,animaltest.getLocationY());
	...
	public void InitialAssertTest6()
	{
		...
		assertEquals("6.Lokasi initial X salah!",0,animaltest.getLocationX());
		assertEquals("6.Lokasi initial Y salah!",0,animaltest.getLocationY());
	...
	public void InitialAssertTest7()
	{
		...
		assertEquals("7.Lokasi initial X salah!",0,animaltest.getLocationX());
		assertEquals("7.Lokasi initial Y salah!",0,animaltest.getLocationY());
	...
	public void InitialAssertTest8()
	{
		...
		assertEquals("8.Lokasi initial X salah!",0,animaltest.getLocationX());
		assertEquals("8.Lokasi initial Y salah!",0,animaltest.getLocationY());
	...
	public void InitialAssertTest9()
	{
		...
		assertEquals("9.Lokasi initial X salah!",0,animaltest.getLocationX());
		assertEquals("9.Lokasi initial Y salah!",0,animaltest.getLocationY());
	...
	public void InitialAssertTest10()
	{
		...
		assertEquals("10.Lokasi initial X salah!",0,animaltest.getLocationX());
		assertEquals("10.Lokasi initial Y salah!",0,animaltest.getLocationY());
	...
	public void InitialAssertTest11()
	{
		...
		assertEquals("11.Lokasi initial X salah!",0,animaltest.getLocationX());
		assertEquals("11.Lokasi initial Y salah!",0,animaltest.getLocationY());
	...
	public void InitialAssertTest12()
	{
		...
		assertEquals("12.Lokasi initial X salah!",0,animaltest.getLocationX());
		assertEquals("12.Lokasi initial Y salah!",0,animaltest.getLocationY());
	...
	public void InitialAssertTest13()
	{
		...
		assertEquals("13.Lokasi initial X salah!",0,animaltest.getLocationX());
		assertEquals("13.Lokasi initial Y salah!",0,animaltest.getLocationY());
	...
	public void InitialAssertTest14()
	{
		...
		assertEquals("14.Lokasi initial X salah!",0,animaltest.getLocationX());
		assertEquals("14.Lokasi initial Y salah!",0,animaltest.getLocationY());
	...
	public void InitialAssertTest15()
	{
		...
		assertEquals("15.Lokasi initial X salah!",0,animaltest.getLocationX());
		assertEquals("15.Lokasi initial Y salah!",0,animaltest.getLocationY());
	...
	public void InitialAssertTest16()
	{
		...
		assertEquals("16.Lokasi initial X salah!",0,animaltest.getLocationX());
		assertEquals("16.Lokasi initial Y salah!",0,animaltest.getLocationY());
	...
	public void InitialAssertTest17()
	{
		...
		assertEquals("17.Lokasi initial X salah!",0,animaltest.getLocationX());
		assertEquals("17.Lokasi initial Y salah!",0,animaltest.getLocationY());
	...
	public void InitialAssertTest18()
	{
		...
		assertEquals("18.Lokasi initial X salah!",0,animaltest.getLocationX());
		assertEquals("18.Lokasi initial Y salah!",0,animaltest.getLocationY());
	...
	public void InitialAssertTest19()
	{
		...
		assertEquals("19.Lokasi initial X salah!",0,animaltest.getLocationX());
		assertEquals("19.Lokasi initial Y salah!",0,animaltest.getLocationY());
	...
	public void InitialAssertTest20()
	{
		...
		assertEquals("20.Lokasi initial X salah!",0,animaltest.getLocationX());
		assertEquals("20.Lokasi initial Y salah!",0,animaltest.getLocationY());
	...
	public void InitialAssertTest21()
	{
		...
		assertEquals("21.Lokasi initial X salah!",0,animaltest.getLocationX());
		assertEquals("21.Lokasi initial Y salah!",0,animaltest.getLocationY());
	...
	public void InitialAssertTest22()
	{
		...
		assertEquals("22.Lokasi initial X salah!",0,animaltest.getLocationX());
		assertEquals("22.Lokasi initial Y salah!",0,animaltest.getLocationY());
	...
	public void InitialAssertTest23()
	{
		...
		assertEquals("23.Lokasi initial X salah!",0,animaltest.getLocationX());
		assertEquals("23.Lokasi initial Y salah!",0,animaltest.getLocationY());
